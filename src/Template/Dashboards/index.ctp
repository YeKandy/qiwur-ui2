...
<div class="crawls index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $crawl['rounds']; ?>&nbsp;</td>
		<td><?php echo $crawl['finished_rounds']; ?>&nbsp;</td>
		<td><?php echo $crawl['limit']; ?>&nbsp;</td>
		<td><?php echo $crawl['state']; ?>&nbsp;</td>
		<td><?php echo $crawl['configId']; ?>&nbsp;</td>
